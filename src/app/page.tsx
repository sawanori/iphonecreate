              ...
              <div className="aspect-video rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
                <div className="relative h-full w-full flex items-center justify-center">
                  ...
                  <div className="absolute bottom-4 sm:bottom-8 left-1/2 -translate-x-1/2 flex flex-row gap-2 sm:gap-4">
                    <div className="rounded-lg sm:rounded-xl bg-gradient-to-r from-[oklch(0.45_0.15_165)] to-[oklch(0.60_0.13_165)] px-2 sm:px-4 py-1 sm:py-2 text-white text-[10px] sm:text-xs font-semibold shadow-lg shadow-[oklch(0.45_0.15_165)]/30 hover:scale-105 transition-transform cursor-pointer text-center whitespace-nowrap">
                      選択肢 A
                    </div>
                    <div className="rounded-lg sm:rounded-xl bg-gradient-to-r from-[oklch(0.80_0.12_165)] to-[oklch(0.45_0.15_165)] px-2 sm:px-4 py-1 sm:py-2 text-white text-[10px] sm:text-xs font-semibold shadow-lg shadow-[oklch(0.80_0.12_165)]/30 hover:scale-105 transition-transform cursor-pointer text-center whitespace-nowrap">
                      選択肢 B
                    </div>
                  </div>
                </div>
